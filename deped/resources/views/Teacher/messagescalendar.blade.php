...
<html>
   ...
   <body>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-lg-3" align="center">
          <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12">
            <a class="btn btn-md waves-effect waves-light m-b-30 button" data-toggle="modal" data-target="#mail"> <i class="fa fa-envelope fa-lg"></i> Mail<span class="badge pull-right" style="background-color: red;">1000</span></a>
          </div>
          <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12">
    ...
    <div class="chat-body-cont">
      ...
      <div class="modal fade" id="compose" role="dialog">
        <div class="modal-dialog modal-lg">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="panel panel-custom">
                <div class="panel-heading"><i class="fa fa-envelope fa-lg"></i> <label>Compose</label></div><br />
      ...
      <!-- your custom script -->
      <!-- JS file -->
      <script src="{!! asset('js/Teacher/messagescalendar.js') !!}"></script>
