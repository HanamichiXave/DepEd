...
<html>
    <head>
        ...
        <link href="{!! asset('assets/custom/css/Teacher/T_ClassAttendance.css') !!}" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <br>
            @include('Teacher.teacher-messages')
            @yield('content')
            <hr />
        ...
        <!-- your custom script -->
        <!-- JS file -->
        <script src="{!! asset('js/Teacher/tclassattendance.js') !!}"></script>
