                  ...
                  <div class="row" >
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="circle-tile">
                           <a href="#">
                              <div class="circle-tile-heading dark-blue db-container">
                                 <i class="fa fa-book fa-fw fa-3x"></i>
                              </div>
                           </a>
                           <div class="circle-tile-content dark-blue db-container">
                        ...
                        <div class="circle-tile">
                           <a href="#">
                              <div class="circle-tile-heading blue db-container">
                                 <i class="fa fa-code fa-fw fa-3x"></i>
                              </div>
                           </a>
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="panel panel-custom">
                  <div class="panel-heading">
                    ...
                    <label>Achievement Score Distribution</label>
                  </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h5>Class Size </h5>
                    <h4>20 <label style="font-size:13px;">Students</label></h4>
                  </div>
                    <div style="position: relative; width:auto;">
                      <canvas id="myChartbar" height="250px"></canvas>
                    </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"> 
                <div class="panel panel-custom">
                  <div class="panel-heading">
                     <i class="fa fa-star"></i>
                    <label>Achievement Trend</label>
                  </div>
                  <div class="panel-body">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <h5>Avg Achievement </h5>
                      <h4 style="color:green">78<i class="fa fa-caret-up fa-fw"></i><label style="font-size:13px;">7.2</label></h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <h5>Avg % Completed </h5>
                      <h4 style="color:#006eff">81<i class="fa fa-caret-up fa-fw"></i><label style="font-size:13px;">9</label></h4>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div style="position: relative; width:auto;">
                        <canvas id="myChartline" height="250px"></canvas>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="panel panel-custom">
                  ...
                  <div class="panel-body">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      ...
                      <h4>8,200<i class="fa fa-caret-up fa-fw"></i><label style="font-size:13px;">300</label></h4><br/>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <h5>Avg Prob Solved</h5>
                      <h4>410<i class="fa fa-caret-up fa-fw"></i><label style="font-size:13px;">12</label></h4>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div style="position: relative; width:auto;">
                        <canvas id="myChartbar2" height="250px"></canvas>
                      </div>
                    </div>
                  </div>
                </div>    
