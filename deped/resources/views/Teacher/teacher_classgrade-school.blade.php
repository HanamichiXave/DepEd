                        ...
                        <div class="panel panel-default">
                          <div class="panel-body">
                            <div class="row">
                              ...
                              <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                  <label>Section : Aquino</label>
                                </div>
                                <div class="form-group">
                                  <label>Day : Monday-Friday</label>
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <a href="{{URL::Route('teacherstudentgradeschool')}}"><button type="button" class="btn btn-success pull-right"><i class="fa fa-eye"></i> View Class</button></a>
                              </div>
                            </div>
                          </div> 
                        </div>
                          ...
                          <div class="panel-body">
                            <div class="row">
                              <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                  <label>Subject : Math</label>
                                </div>
                              </div>
                              <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                  <label>Section : Masipag</label>
                                </div>
                                <div class="form-group">
                                  <label>Day : Monday-Friday</label>
                                </div>
                          ...
                          <div class="panel-body">
                            <div class="row">
                              <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                  <label>Subject : Filipino</label>
                                </div>
                              </div>
                              <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                  <label>Section : Ruby</label>
                                </div>
                                <div class="form-group">
                                  <label>Day : Monday-Friday</label>
                                </div>
                          ...
                          <div class="panel-body">
                            <div class="row">
                              <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                  <label>Subject : Science</label>
                                </div>
                              </div>
                              <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                  <label>Section : Rizal</label>
                                </div>
                                <div class="form-group">
                                  <label>Day : Monday-Friday</label>
                                </div>
                          ...
                          <div class="panel-body">
                            <div class="row">
                              <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                  <label>Subject : Pluto</label>
                                </div>
                              </div>
                              <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                  <label>Section : MSEP</label>
                                </div>
                                <div class="form-group">
                                  <label>Day : Monday-Friday</label>
                                </div>
