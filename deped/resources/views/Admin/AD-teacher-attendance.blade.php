...
<head>
	...
	<!-- end of css  -->
	<!-- your custom css -->
	<link href="{!! asset('assets/custom/css/Admin/AD_Mainpage.css') !!}" rel="stylesheet">
...
<body>
	...
	<div class="container" >
        ...
        <ol class="breadcrumb" style="background-color: #D9EDF7">
           ...
           <li>Teacher and Staff, Attendance and Profile</li>
        </ol>
	...
	<!-- footer here -->
        ...
        <footer class="navbar-fixed-bottom">
            <div class="container-fluid footer">
                <p class="pull-right powerby">&copy; 2016 - Powered by <a href="http://www.simplevia.com quicktrackcolor">QuickTrack</a></p>
            </div>
        </footer>
	<!-- end foooter -->
	</div>
