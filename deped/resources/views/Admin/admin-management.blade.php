...
<head>
    ...
    <link href="{!! asset('assets/custom/css/Admin/AD_Mainpage.css') !!}" rel="stylesheet" type="text/css" />
</head>
<style>
...
<body>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
            <a href="{{URL::Route('studpreadmission')}}" >
                <div class="hovereffect">
                    <img class="img-responsive" src="{!! asset('assets/images/studentpreLogo.png') !!}" height="100" width="100" alt="">
                    <div class="overlay">
                       <h2>Student Pre-Admission</h2>
                        <p class="info">
                               Contains the student application form, student requirement and pre admission result, and list of students pre-admission.
                        </p>
                    </div>
                </div>
            </a>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
            <a href="{{URL::Route('enrollment')}}" >
                <div class="hovereffect">
                    <img class="img-responsive" src="{!! asset('assets/images/enrollmentlogo.png') !!}" height="100" width="100" alt="">
                    <div class="overlay">
                       <h2>Student Enrollment</h2>
                        <p class="info">
                               Contains forms a student must fill-up in order to enroll.
                        </p>
                    </div>
                </div>
            </a>
