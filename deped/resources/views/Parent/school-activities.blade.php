    ...
    <div class="row">
          <div class="col-xs-12 col-sm-5 col-sm-offset-7 col-md-4 col-md-offset-8 col-lg-3 col-lg-offset-9">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 no-padding">
                <form action="" method="get" style=" margin-bottom:25px;" class="form-inline">
                  <input list="children" name="browser" class="form-control" placeholder="Search a child">
                  <datalist id="children">
                    <option value="John Mayson">
                    <option value="John Xavier">
                    <option value="John Benson">
                    <option value="John Ivan">
                    <option value="John Carl">
                  </datalist>
                </form>
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 no-padding">
                <button class="btn btn-info" style="width:100%;">Search</button>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <a href="{{URL::Route('parentgrades')}}" >
