   ...
   <body>
    ...
    <!-- navigation bar  -->
        ...
        <div class="container" >
          <br>
          <br>
          <div class="page-header" style="color: #000033"><h2><strong>View Subject</strong></h2></div>
          <ol class="breadcrumb">
      ...
      <div class="panel panel-custom">
        <div class="panel-heading"><h5>Subject List</h5></div>
         <div class="panel-body">
           ...
           <div class="table-responsive">
              <table class="table table-striped table-hover" id="subjectList">
                  <thead>
                      <tr>
                  ...
                  <tbody>
                      <tr class="">
                          ...
                          <td></td>
                          <td>Grade V / Pilot</td>
                          <td>Ms. Jhamila Okla</td>
                          <td>Mathematics</td>
                          <td>Mrs. Avegin Sanches</td>
                          <td><a href="../../views/Parent/view-attendance.html"><button class="btn btn-info" id="" name="">View Attendance</button></a></td>
                          <td><a href="../../views/Parent/view-grade.html"><button class="btn btn-warning" id="" name="">View Grades</button></a></td>
                      </tr>
                      <tr class="">
                          <td></td>
                          <td></td>
      ...
      <script type="text/javascript">
              $(document).ready(function(){
                 var oTable = $('#subjectList').DataTable({
                   "orderCellsTop": false,
