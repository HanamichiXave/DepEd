...
<html>
   ...
   <body>
      ...
      <div class="panel panel-custom">
              <div class="panel-heading" style="font-size: 20px; font-weight: 350;"><i class="fa fa-male fa-lg"></i> Student List
               </div>
               <div class="panel-body">
                  ...
                  <div class="row">
                     ...
                     <div class="table-responsive">
                        <table class="display nowrap table table-striped table-hover"  id="myTable">
                           <thead>
                              <tr>
                           ...
                           <tbody>
                              <tr class="">
                                 ...
                                 <td>
                                  <select id="1st">
                                      ...
                                      <option value="{{URL::Route('transcript')}}">Transcript of Records</option>
                                      <option value="{{URL::Route('diploma')}}">Diploma</option>
                                      <option value="{{URL::Route('form137')}}">Form 137</option>
                                  </select>
                                 </td>
                                 <td><a id="view1" href="" class="btn btn-info" id="" name="" type="button">View</a></td>
                              </tr>
                              <tr class="">
                                 <td></td>
                                 <td></td>
                                 ...
                                 <td>
                                  <select id="2nd">
                                      <option disabled selected value> -- Select Document Type -- </option>
                                      <option value="{{URL::Route('transcript2')}}">Transcript of Records</option>
                                      <option value="{{URL::Route('diploma2')}}">Diploma</option>
                                      <option value="{{URL::Route('form1372')}}">Form 137</option>
                                  </select>
                                 </td>
                                 <td><a id="view2" href="" class="btn btn-info" id="" name="" type="button">View</a></td>
                              </tr>
                              <tr class="">
                                 <td></td>
                                 <td></td>
                                 ...
                                 <td>
                                  <select id="3rd">
                                      <option disabled selected value> -- Select Document Type -- </option>
                                      <option value="{{URL::Route('transcript3')}}">Transcript of Records</option>
                                      <option value="{{URL::Route('diploma3')}}">Diploma</option>
                                      <option value="{{URL::Route('form1373')}}">Form 137</option>
                                  </select>
                                 </td>
                                 <td><a id="view3" href="" class="btn btn-info" id="" name="" type="button">View</a></td>
                              </tr>
                              <tr class="">
                                 <td></td>
                                 <td></td>
                                 ...
                                 <td><a href="{{URL::Route('transcript')}}" class="btn btn-info" id="" name="" type="button">View</a></td>
                              </tr>
                              <tr class="">
                                 <td></td>
                                 <td></td>
                              ...
                              <tr class="">
                                 ...
                                 <td>
                                  <select>
                                      <option disabled selected value> -- Select Document Type -- </option>
                                      <option value="transcript.html">Transcript of Records</option>
                                      <option value="diploma.html">Diploma</option>
                                      <option value="form137.html">Form 137</option>
                                  </select>
                                 </td>
                                 <td><a href="{{URL::Route('transcript')}}" class="btn btn-info" id="" name="" type="button">View</a></td>
                              </tr>
      ...
      <!-- JS file -->
      <script src="{!! asset('js/Principal/document.js') !!}"></script>
      <!-- your custom script -->
