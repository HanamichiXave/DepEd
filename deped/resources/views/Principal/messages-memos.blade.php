...
<html>
   <head>
      ...
      <link href="{!! asset('assets/custom/css/Messages&Memos/custom.css') !!}" rel="stylesheet">
      ...
      <link href="{!! asset('assets/calendar/fullcalendar.print.min.css') !!}" rel='stylesheet' media='print' />
        ...
        <div class="row ">
          <div class="col-md-9 col-lg-9">
            <ul class="nav nav-tabs nav-pills">
              <li class="active"><a data-toggle="tab" href="#todo" aria-expanded="true"><strong> Do Things</strong></a></li>
              <li class=""><a data-toggle="tab" href="#schoolcalendar" aria-expanded="false"><strong> School Calendar</strong></a></li>
            </ul>
            <div class="tab-content">
              <div id="todo" class="tab-pane fade in active">
                <div class="panel panel-custom">
                  <div class="panel-heading"><i class="fa fa-list-alt fa-lg"></i> <label>To Do Lists</label></div><br>
                  <div class="panel-body-calendar">
                    <div id="calendar"></div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-offset-6 col-lg-offset-6 col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group">
                    <div class="messagepop pop">
                      <form method="post" id="new_message" action="/messages">
                        ...
                        <div class="col-lg-12 form-group">
                          <textarea class="form-control" style="height: 100px;" placeholder="Enter Text Here"></textarea>
                        </div>
                        <div class="col-lg-12 form-group">
                          <div class="pull-right">
                            <a class="btn btn-info btn-md"> Save</a>
                          </div>
                        </div>
                      </form>
                    </div>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-custom">
                      <div class="panel-heading"><i class="fa fa-sticky-note-o fa-lg"></i> <label>Notes</label></div>
                      <div class="panel-body" style="margin-top: 10px;">
                        <div class="col-lg-12 form-group">
                            <a class="btn btn-md button" href="/contact" id="contact"> <i class="fa fa-plus fa-lg"></i> Add New</a>
                        </div>
                        <div class="col-lg-12 form-group">
                          <ul>
                            <li><label>Meeting With All Faculty and Staff on November 3,2017</label></li>
                            <li><label>Christmas Party Moved on December 23,2017</label></li>
                            <li><label>Semester's Break Starts on December 23, 2017 to January 4, 2018</label></li>
                            <li><label>Fire Drill on March 18, 2018</label></li>
                          </ul>
                        </div>
                      </div>
                    </div>
              ...
              <div id="schoolcalendar" class="tab-pane fade in fade">
                <div class="panel panel-custom">
                  <div class="panel-heading"><i class="fa fa-calendar fa-lg"></i> <label>School Schedules &amp; Events</label></div><br />
                  <div class="panel-body-calendar">
                    <div clas="row">
                  ...
                  <!-- <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                    <div class="carousel-inner">
                      ...
                      <div class="item active">
                        <div class="month">      
                          <ul>
                            <li>
                              <span style="font-size:18px">SY: 2017 - 2018</span><br>
                              June
                            </li>
                          </ul>
                        </div>
                    ...
                    <a class="left carousel-control" href="#myCarousel" data-slide="prev">
                      <i class="fa fa-chevron-left fa-lg leftcalendar"></i>
                    </a>
                    <a class="right carousel-control" href="#myCarousel" data-slide="next">
                      <i class="fa fa-chevron-right fa-lg rightcalendar"></i>
                    </a>
                  </div> -->
                </div>
                <div class="row">
          ...
          <div class="col-md-3 col-lg-3">
            <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12">
              <a class="btn btn-md button" data-toggle="modal" data-target="#creatememo"> <i class="fa fa-pencil fa-lg"></i> Create Memo</a>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12">
              <a class="btn btn-md button" data-toggle="modal" data-target="#mail"> <i class="fa fa-envelope fa-lg"></i> Mail<span class="badge pull-right" style="background-color: red;">35</span></a>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12">
              <a class="btn btn-md button" data-toggle="modal" data-target="#contacts"> <i class="fa fa-phone-square fa-lg"></i> Contacts</a>
            </div>
           <!--  <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12 dropdown" id="chat">
              <a class="btn btn-md button dropbtn" onclick="myFunction()"> <i class="fa fa-commenting fa-lg"></i> Chat</a>
              <div id="myDropdown" class="dropdown-content">
                <div class="chatcontacts pull-left"> -->
                    <!-- Pass username and display name to register popup -->
                    <!-- <a href="javascript:register_popup('john-xavier', 'John Xavier', '../../content/images/Teacher/xavier.jpg');">
                        <img width="30" height="30" id="id1" src="../../content/images/Teacher/xavier.jpg" />
                        <span>John Xavier</span>&nbsp;<img width="10" height="10" src="../../content/images/online.png" />
                    </a>
                </div>
                <div class="chatcontacts pull-left">
                    <a href="javascript:register_popup('john-benson', 'John Benson', '../../content/images/Teacher/benson.jpg');">
                        <img width="30" height="30" id="id2" src="../../content/images/Teacher/benson.jpg" />
                        <span>John Benson</span>&nbsp;<img width="10" height="10" src="../../content/images/online.png" />
                    </a>
                </div>
                <div class="chatcontacts pull-left">
                    <a href="javascript:register_popup('john-mayson', 'John Mayson', '../../content/images/Teacher/mayson.png');">
                        <img width="30" height="30" id="id3" src="../../content/images/Teacher/mayson.png" />
                        <span>John Mayson</span>&nbsp;<img width="10" height="10" src="../../content/images/online.png" />
                    </a>
                </div>
                <div class="chatcontacts pull-left">
                    <a href="javascript:register_popup('john-ivan', 'John Ivan', '../../content/images/Teacher/ivan.jpg');">
                        <img width="30" height="30" id="id4" src="../../content/images/Teacher/ivan.jpg" />
                        <span>John Ivan</span>&nbsp;<img width="10" height="10" src="../../content/images/online.png" />
                    </a>
                </div>
                <div class="chatcontacts pull-left">
                    <a href="javascript:register_popup('john-bea', 'John Bea', '../../content/images/Teacher/Bea.jpg');">
                        <img width="30" height="30" id="id5" src="../../content/images/Teacher/Bea.jpg" />
                        <span>John Bea</span>&nbsp;<img width="10" height="10" src="../../content/images/online.png" />
                    </a>
                </div>
                <div class="chatcontacts pull-left">
                    <a href="javascript:register_popup('john-antonio', 'John Antonio', '../../content/images/Teacher/Bravo.jpg');">
                        <img width="30" height="30" id="id6" src="../../content/images/Teacher/Bravo.jpg" />
                        <span>John Antonio</span>&nbsp;<img width="10" height="10" src="../../content/images/online.png" />
                    </a>
                </div> -->
   ...
   <div class="chat-body-cont">
        ...
        <!-- Modal For Create New Memo -->
        <div class="modal fade" id="creatememo" role="dialog">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <!-- <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="panel-body" style="margin-bottom: 10px;">
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                          ...
                          <div class="col-xs-9 col-sm-7 col-md-6 col-lg-5">
                            <input class="form-control" id='date' name='date' disabled>
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                            <div class="col-xs-3 col-sm-2 col-md-1 col-lg-1">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                          ...
                          <div class="col-xs-9 col-sm-7 col-md-6 col-lg-5">
                            <input class="form-control" id="carbon" name="carbon">
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                          <div class="col-xs-3 col-sm-2 col-md-1 col-lg-1">
                          ...
                          <div class="col-xs-9 col-sm-7 col-md-6 col-lg-5">
                            <input class="form-control" id="re">
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                          <div class="col-xs-3 col-sm-2 col-md-1 col-lg-1">
                        ...
                        <!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                          ...
                          <div class="col-xs-9 col-sm-7 col-md-6 col-lg-5">
                            <select class="form-control" id="sel1">
                              <option selected disabled>Select</optgroup>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                          <div class="col-lg-12">
                            <textarea class="form-control" style="height: 150px;" id="field"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="modal-footer">
                  <button class="btn btn-primary" id="print" onclick="printPage()" type="submit"><i class="fa fa-print"></i> Save &amp; Print</button>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-7 col-md-9 col-lg-9">
                          <div class="form-group">
                            <div class="popover-markup"> 
                              <a class="trigger btn btn-info"><i class="fa fa-plus"></i> Add New</a>
                              <div class="head hide">Add New Contact</div>
                              <div class="content hide">
                                <div class="form-group">
                                  <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <figure>
                                      <img src="https://vignette.wikia.nocookie.net/expanse/images/8/80/Char_icon.png/revision/latest?cb=20170225162026" id="" style="display: fixed; margin: auto;" height="120" width="120" placeholder="Upload Photo">
                                      <figcaption>
                                        <span class="btn btn-file">
                                        <input class="required input-sm" type="file" id="imgInp3" name="file" style="width: 90px;">
                                        </span>
                                      </figcaption>
                                    </figure>
                                  </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="avatar">
                              <img alt="" src="https://scontent.fmnl4-2.fna.fbcdn.net/v/t1.0-1/p160x160/21272248_1880894221926819_3661498612912457806_n.jpg?oh=072ac973a2b15e439764633a8ef717d3&oe=5A8DE279">
                            </div>
                            <div class="info">
                              <div class="title">
                                <label>John Mayson Labuntog</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> maysonlabuntog.jml@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 09152155717</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Lot 29 Block 4 Batahai Subd. Purok 7, Bagong Tanyag, Taguig City</div>
                            </div>
                            <div class="bottom">
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>John Xavier Buenaventura</label>
                              </div>
                              <div class="desc">Parent</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> xavier@simplevia.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 098274654632</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Guadalupe, Manila</div>
                            </div>
                            <div class="bottom">
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>John Benson Quebral Leabres</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> benson@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 098764738213</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Neuva Ecija, Philippines</div>
                            </div>
                            <div class="bottom">
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>Genesis Ivan Joson Aquino</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> genesis@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 0987654673</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Pasig, Taguig</div>
                            </div>
                            <div class="bottom">
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>Carl Joseph Gorgonia</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> cj@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 0984756842384</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Metro Manila, Philippines</div>
                            </div>
                            <div class="bottom">
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>Avegin Villaranda Sanchez</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> avegin@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 0987563262284</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Metro Manila, Philippines</div>
                            </div>
                            <div class="bottom">
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>Antonio Bravo</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> bravo@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 09152155717</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Nueva Ecija, Philippines</div>
                            </div>
                            <div class="bottom">
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>Bea Trixia Casuncad Saducos</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> bea@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 093748347261</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Makati, Philippines</div>
                            </div>
                            <div class="bottom">
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>Eliseo De Leon Balido</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> eli@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 0987475865856</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Makati, Philippines</div>
                            </div>
                            <div class="bottom">
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div class="card hovercard">
                            ...
                            <div class="info">
                              <div class="title">
                                <label>Jham Okla</label>
                              </div>
                              <div class="desc">Teacher</div>
                              <div class="desc"><i class="fa fa-envelope-o"></i> jham@gmail.com</div>
                              <div class="desc"><i class="fa fa-phone"></i> 0987475865856</div>
                              <div class="desc"><i class="fa fa-map-marker"></i> Makati, Philippines</div>
                            </div>
                            <div class="bottom">
      ...
      <!-- Print Memo -->
      <div id="goodmoral" class="goodmoral" style="height: 12in; width: 11.5in;" >
        <img src="{!! asset('assets/images/memo.jpg') !!}" style="height: auto; width: 200%;">
        <p id="to2" style="position: absolute; left: 20%; top: 31.4%; font-size: 17px;"></p>
        <p id="from2" style="position: absolute; left: 20%; top: 34.7%; font-size: 17px;"></p>
        <p id="carbon2" style="position: absolute; left: 20%; top: 38%; font-size: 17px;"></p>
        <p id="date2" style="position: absolute; left: 20%; top: 41.1%; font-size: 17px;"></p>
        <p id="re2" style="position: absolute; left: 20%; top: 44.33%; font-size: 17px;"></p>
        <p id="subject2" style="position: absolute; left: 13%; top: 49%; font-size: 23px;"></p>
        <p id="field2" style="position: absolute; left: 13%; top: 55%; font-size: 17px;"></p>
      </div>
      ...
      <!-- JS file -->
      <script src="{!! asset('js/Principal/messagesmemos.js') !!}"></script>
      <!-- your custom script -->
      <!-- <script type="text/javascript">
        ...
        $("#narayan-prusty").on('change', '#chatmessage',  function(){
            alert("Enter pressed");
        });
