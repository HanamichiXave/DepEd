    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          	...
          	<img class="img-responsive" src="{!! asset('assets/images/Super Admin/v5/dashboard.png') !!}" width="100" height="100" />
             	<div class="overlay">
                	<h2>Dashboard</h2>
                  <p class="info">
                    Provides in-depth data analysis, organizes and presents information regarding financial activities inside the school.
                  </p>
              </div>
        	</div>
       		</a> 
       	...
       	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
      		<a href="{{URL::Route('studentDesk')}}">
         		<div class="hovereffect">
              <img class="img-responsive" src="{!! asset('assets/images/studentdesk.png') !!}" width="100" height="100" />
               	<div class="overlay">
                	<h2>Student Desk</h2>
                  <p class="info">
                    Monitor a student's record and other informations.
                  </p>
                </div>
          	</div>
       		</a> 
       	...
       	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <a href="{{URL::Route('teacherDesk')}}">
            <div class="hovereffect">
              <img class="img-responsive" src="{!! asset('assets/images/teacherdesk.png') !!}" width="100" height="100" />
                <div class="overlay">
                  <h2>Teacher Desk</h2>
                  <p class="info">
                    Monitor a teacher's record and other informations.
                  </p>
                </div>
            </div>
          </a> 
          ...
          <a href="{{URL::Route('messagesMemos')}}">
            <div class="hovereffect">
              <img class="img-responsive" src="{!! asset('assets/images/memo.png') !!}" width="100" height="100" />
                <div class="overlay">
                  <h2>Messages &amp; Memo's</h2>
                  <p class="info">
